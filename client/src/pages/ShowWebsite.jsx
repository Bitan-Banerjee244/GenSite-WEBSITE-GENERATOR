      ...
      {isFull ? (
        <div className="fixed inset-0 z-50 flex flex-col bg-black">
          ...
          <div className="flex-1 relative">
            ...
            {/* RIGHT EDITOR */}
            {showEditor && (
              <div className="absolute top-0 right-0 h-full w-[90%] sm:w-[75%] md:w-[60%] lg:w-[45%] bg-black border-l border-gray-800 z-50 flex flex-col">
                {/* HEADER */}
        ...
        <div className="flex h-screen w-full ">
          {/* LEFT CHAT */}
          <div
            className={`${showChat ? "w-full md:w-[25%]" : "hidden md:w-[25%] md:flex"}  border-r border-gray-900 flex flex-col`}
          >
          ...
          <div className="w-full md:w-[75%] flex flex-col">
            ...
            <div className="flex md:flex-row flex-col gap-5 md:items-center justify-between px-2 md:px-4 py-3 border-b border-gray-900">
              <div className="flex justify-between px-2 md:block">
            ...
            <div className="flex-1 relative">
              ...
              {showEditor && (
                <div className="absolute top-0 right-0 h-full w-full md:w-[65%] bg-black border-l border-gray-800 z-50 flex flex-col">
